...
/**
 *Carga los usuarios en base ... es decir los usuarios que estan en el archivo users.json
 */
...
/**
 *Guarda los usuarios en base ... es decir en el archivo users.json
 */
function saveUsers () {
  try {
...
/**
 *Compara el password para el servicio de autenticacion
 */
